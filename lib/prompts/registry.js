...
const registry = {
  ...
  'practice.mc_cloze': {
    ...
    compose({ ttsLocale, card, seedCardNames, skillType, problemType = 'mc_cloze', extraPrompt, vocabularyPolicy }) {
      ...
      const sections = [
        `Generate a single multiple-choice cloze exercise to drill one specific skill in ${lang}. Respond only by calling the emit_mc_cloze_item tool — no other text.`,
