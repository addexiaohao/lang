  ...
  mc_cloze: {
    ...
    input_schema: {
      ...
      properties: {
        ...
        frame: {
          type: 'string',
          description: 'Only for a skill that drills which preposition or conjunction to produce: the specific governing choice you made FIRST, before writing the sentence — for a preposition skill, the exact verb/adjective/construction that genuinely, idiomatically governs the target preposition in this exact use-case (e.g. "sich erinnern an", not just any verb that could loosely take "an"); for a conjunction skill, the one-line relationship between the two clauses that only this conjunction expresses (e.g. "a single past occasion, not habitual — rules out wenn"). Omit entirely for every other skill/problem type.',
        },
        distractor_reasons: {
          type: 'array',
          items: {
