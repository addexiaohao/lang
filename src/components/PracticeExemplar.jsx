...
// Exemplar feed exercise body. `item` is a practice.exemplar response: { sentence, target_span, sense_key, translation }.
export default function PracticeExemplar({ item, onVerstanden, onNochEinSatz, onExplain, onAddSource, addSourceDisabled }) {
  const [showTranslation, setShowTranslation] = useState(false)
  useEffect(() => { setShowTranslation(false) }, [item])
